...
pub fn TaskForm(
    ...
    view! {
        <Card class="bg-glass-dark p-8 shadow-orange-sm">
            <form on:submit=on_submit>
                <div class="flex flex-col gap-8">
                    <div class="flex flex-col gap-6">
                        <div class="flex flex-col">
                            ...
                            <input
                                id="task-title"
                                type="text"
                                class="bg-white/10 border border-orange-30 rounded-lg p-4 w-full text-ash font-medium focus:border-orange focus:shadow-orange-sm"
                        ...
                        <div class="flex flex-col">
                            ...
                            <textarea
                                id="task-description"
                                class="bg-white/10 border border-orange-30 rounded-lg p-4 w-full text-ash font-medium focus:border-orange focus:shadow-orange-sm min-h-[80px] resize-y"
                    ...
                    <div class="flex flex-col md:flex-row gap-6">
                        <div class="flex flex-col flex-1">
                            ...
                            <div class="relative">
                                <select
                                    id="task-goal"
                                    class="bg-white/10 border border-orange-30 rounded-lg p-4 w-full text-ash font-medium focus:border-orange focus:shadow-orange-sm pr-10"
                                    on:change=move |ev| {
                    ...
                    <div class="flex justify-start mt-2">
                        <Button
                            class="btn btn-orange hover-lift shadow-orange-sm"
